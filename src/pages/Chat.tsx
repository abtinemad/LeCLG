...
import { WORKER_URL, toWorkerMessages } from "../lib/chat-helpers";
...
export default function Chat() {
  ...
  const streamChat = useStreamChat({
    ...
    pastStepSets, projectionDetected, patternRecognized, alliance,
    recurringWords, motifSurfaced, stallSurfaced, absenceSurfaced,
  });
